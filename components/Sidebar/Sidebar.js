    ...
    render() {
        return (
            <div id="sidebar" className="user-account-menu">
                <div className="user-account-head-item border-bottom">
                    <p className="user-account-head-icon icon-profile">
                ...
                {this.props.user_data.role === "vendedor" &&
                    <div
                        className={this.state.closeBill ? "user-account-menu-item" : "user-account-menu-item active"}
                        onClick={() => this.accordionBill()}
                    >
                        <p className="user-account-menu-icon"><FontAwesomeIcon icon={faMoneyBillWave} /></p>
                        <div className="user-account-menu-accordion">
                            ...
                            <div className="user-account-accordion">
                                ...
                                <p onClick={(e) => this.props.cb("myProducts", e)} >Publicaciones</p>
                                <p onClick={(e) => this.props.cb("mySales", e)} >Ventas</p>
                ...
                {this.props.user_data.role === "user" &&
                        ...
                        <p onClick={(e) => this.props.cb("myData", e)} >Favoritos</p>
