      ...
      <div id='sidebar' className='user-account-menu'>
        <div className='user-account-menu-wrapper'>
          ...
          {this.props.user_data.role === "vendedor" && (
            <div
              className={
                this.state.closeBill
                  ? "user-account-menu-item"
                  : "user-account-menu-item actives"
              }
              ...
              <div className='user-account-menu-accordion'>
                ...
                <div className='user-account-accordion'>
                  ...
                  <p
                    onClick={(e) => {
                      if (window.location.pathname === "/cuenta") {
                        this.props.cb("myProducts", e);
                      } else {
                        Router.push("/cuenta#products");
                      }
                    }}
                  >
                    Publicaciones
                  ...
                  <p
                    onClick={(e) => {
                      if (window.location.pathname === "/cuenta") {
                        this.props.cb("mySales", e);
                      } else {
                        Router.push("/cuenta#ventas");
                      }
                    }}
                  >
                    Ventas
                  ...
                  <p
                    onClick={(e) => {
                      if (window.location.pathname === "/cuenta") {
                        this.props.cb("questions", e);
                      } else {
                        Router.push("/cuenta#questions");
                      }
                    }}
                  >
                    Preguntas
          ...
          <div
            className={
              this.state.closeMyData
                ? "user-account-menu-item border-bottom"
                : "user-account-menu-item border-bottom actives"
            }
            ...
            <div className='user-account-menu-accordion'>
              ...
              <div className='user-account-accordion'>
                <p
                  onClick={(e) => {
                    if (window.location.pathname === "/cuenta") {
                      this.props.cb("myData", e);
                    } else {
                      Router.push("/cuenta#opciones");
                    }
                  }}
                >
                  Mis datos
