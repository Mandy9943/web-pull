			...
			<div className="question-problem">
				...
				<div className="question-problem-content">
					<div className="question-problem-box">
						<p>
							¿Cómo solucionar un inconveniente para hacer preguntas en una publicación?
						</p>
						<p>
							Es posible que el vendedor te haya bloqueado. Puedes comunicarte con nuestro
							equipo de atención al cliente a través de nuestro correo
						</p>

						<a
							href="mailto:soporte@kiero.co?Subject=Problema%20el%20preguntas%20"
