				...
				<div className="help-top">
					<div className="content-help-top">
						{this.state.accordionAskInPostTitle ? (
							<h1>
								{this.state.accordionTip
									? '¿En qué podemos ayudarte?'
									: '¿Cuándo opinar sobre el vendedor?'}
							</h1>
						) : (
							<h1>Te asesoramos para realizar tus preguntas</h1>
						)}
						<div className="help-search">
							...
							/>
							{this.state.resultBoxDisplay ? (
								<ul ref={this.resultBoxRef} className="help-result-box">
									<Link href="/reputacion_de_vendedor">
										<li>
											<div>
												<FontAwesomeIcon className="listIcon" icon={faSearch} />
												Como saber a quien comprarle
											</div>
										</li>
									</Link>
									...
									<Link href="/como_ayudarte">
										<li>
											<div>
												<FontAwesomeIcon className="listIcon" icon={faSearch} />
												Solucionar problemas en la compra
											</div>
										</li>
									</Link>
									...
									<li onClick={() => this.resultSearcher(1)}>
										<div>
											<FontAwesomeIcon className="listIcon" icon={faSearch} />
											¿En qué momento debo opinar sobre el vendedor?
										</div>
									</li>
									<li onClick={() => this.resultSearcher(2)}>
										<div>
											<FontAwesomeIcon className="listIcon" icon={faSearch} />
											Preguntar en publicaciones
										</div>
									</li>
									<li onClick={() => this.resultSearcher(3)}>
										<div>
											<FontAwesomeIcon className="listIcon" icon={faSearch} />
											Crear una cuenta como empresa
										</div>
									</li>
									<Link href="/recuperar">
										<li>
									...
									<Link href="/proteccion_vendedor">
										<li>
											<div>
												<FontAwesomeIcon className="listIcon" icon={faSearch} />
												¿Seguridad proporcionada para los vendedores?
											</div>
										</li>
									</Link>
									<Link href="/seguridad">
										<li>
											<div>
												<FontAwesomeIcon className="listIcon" icon={faSearch} />
												¿Cómo resguardar la seguridad de mi cuenta?
											</div>
										</li>
									</Link>
									<li id="noneResults">
