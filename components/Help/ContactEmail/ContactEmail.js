	...
	handleSubmit = async (e) => {
		...
		if (error) {
			this.setState({
				error: null,
				success:
					'Hemos recibido su solicitud, un asesor se pondra en contacto contigo a la brevedad posible.',
			});
			return false;
		} else {
			this.setState({
				error:
					'Se produjo un error al crear tu solicitud, por favor intentalo nuevamente en unos minutos.',
				success: null,
			});
			return false;
		}
					...
					<div className="contact-email-content">
						<div className="contact-email-box">
							...
							<div className="code-input">
								<input placeholder="Correo electrónico" name="mail" />
							</div>
