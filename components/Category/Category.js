...
class Category extends Component {
    ...
    searchCategoryLevel = (name='') => {
        try {
            ...
            let endpoint = categoryApi + '?'+ params.toString()
            ...
            if (this.state.treeSelectedCategory.length === 0 || this.props.data.type === 'category') {
                ...
                switch (this.state.treeSelectedCategory.length) {
                    ...
                    case 2:
                        ...
                        break
                    case 3:
                        mergedCategories[this.state.treeSelectedCategory[0].index].items[this.state.treeSelectedCategory[1].index].items.forEach((value, index) => {
                        ...
                        break
                    case 4:
                        mergedCategories[this.state.treeSelectedCategory[0].index].items[this.state.treeSelectedCategory[1].index].items[this.state.treeSelectedCategory[2].index].items.forEach((value, index) => {
        ...
        categoryLevel.then((response) => {
            ...
            if (this.state.categoryLevel === '') {
                ...
                if (this.state.categoryLevel === 0) {
                    ...
                    tmpTreeSelectedCategory.push({"index": index, "key": node.key, "level": this.state.categoryLevel})
