...
const FormProductDetail = ({ handleClose, open }) => {
  ...
  const fullName =
    handleFormatName(getValues().firstName) + (getValues().lastName ? ' ' + handleFormatName(getValues().lastName) : '')

  var hmacID = CryptoJS.HmacSHA1(state.identification, 'abc').toString(CryptoJS.enc.Hex)
  ...
  var signature = md5(`uzIc90bkpXj0aJDh22H67MRJnl~530932~${ref_code}~${productData.price * quantity}~COP`)
  return (
    <div>
      <FormDialog open={open} handleClose={handleClose}>
        <div id="FormProductDetail">
          ...
          >
            ...
            <input name="description" type="hidden" value={productData.title.substr(0, 159)} />
            <input name="referenceCode" type="hidden" value={ref_code} />
            <input name="amount" type="hidden" value={quantity * productData.price} />
            ...
            <input name="telephone" type="hidden" value={getValues().phoneNumber} />
            <input name="shippingCountry" type="hidden" value="CO" />
            <input name="shippingCity" type="hidden" value={getValues().city} />
            <input name="shippingAddress" type="hidden" value={getValues().address} />
