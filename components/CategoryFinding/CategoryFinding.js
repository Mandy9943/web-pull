		...
		return (
			<div className="finding-category">
				...
				<a href={'/categoria/' + this.props.link_left.replace(/ /g, "-").toLowerCase()}>
						<img loading="lazy" src={this.props.img_left} alt={this.props.link_left.replace(/-/g, ' ')} />
				</a>
				...
				<a href={'/categoria/' + this.props.link_right.replace(/ /g, "-").toLowerCase()} >
						<img loading="lazy" src={this.props.img_right} alt={this.props.link_right.replace(/-/g, ' ')} />
				</a>
			</div>
		);
	}
