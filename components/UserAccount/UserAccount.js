...
export default class UserAccount extends Component {
    ...
    render() {
        ...
        const content1 = (
            <>
                <form className="form" onSubmit={this.saveDocument}>
                    <div className="header-modal">
                        ...
                        <div className="modal-actions">
                            ...
                            <div className="cancel-btn" onClick={() => { this.toggleModal(1); }}>
                                <p>
                                    Cancelar
                                </p>
                            </div>
                                    ...
                                    <div className="user-accunt-document">
                                        ...
                                        {this.state.modal1 ? ( <Modal toggle={this.toggleModal} num="1" content={content1} button /> ) : null}
                                        {
                                            this.state.userData.id_number ?
                                                <p>{dt_text+" "+this.state.userData.id_number}</p>
                                            :
...

                                        {
                                            this.state.userData.phone ?
                                                <div onClick={() => { this.toggleModal(2); }}>
                                                    <p >{this.state.userData.phone}</p><p className="modal-btn">Cambiar</p>
                                                </div>
                                                :
                                                <div onClick={() => { this.toggleModal(2); }}>
                                                    <p className="modal-btn">Agregar</p>
