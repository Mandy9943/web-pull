...
export default class addAddress extends React.Component {
    ...
    validateNeighborhood(event){
        const { name, value } = event.target;
        const pattern = new RegExp("^[a-zA-Z\u0080-\uFFFF ]+$");
        this.setState({
            neighborhood: pattern.test(value)? value: value.slice(0,-1)
        })
    }
    ...
    getDepartments(){
        const x = this.departments.map((dep, i) => {
            return <option key={i}>{dep.departamento}</option>;
        });
        return x;
    }
                    ...
                    <div className="add-address-box">
                        <form onSubmit={this.newAddress}>
                            <label>
                                ...
                                <input onChange={this.validateName} value={this.state.name} type="text" required name={"names"} />
                            </label>
                            <div className="add-address-input content-accordion-form">
                                <label>
                                    <p>
                                        Departamento
                                    </p>
                                    <Select name={"department"} onChange={this.setDepartment}>
                                        {this.getDepartments()}
                                    </Select>
                                </label>
                                <label>
                                    ...
                                    <Select name={"city"} >
                                        {this.departments.filter(item => item.departamento == this.state.department )[0].ciudades.map((city, i) => {
                            ...
                            <label>
                                ...
                                <input onChange={this.validateNeighborhood} value={this.state.neighborhood} type='text' required name={"neighborhood"}/>
                            </label>
                            <label>
                                <p>
                                    Dirección
                                ...
                                <div className="input-form content-accordion-form add-direction">
                                    ...
                                    <input required name={"address2"}/>
                                    <input required name={"address3"}/>
                                </div>
                            ...
                            <label>
                                ...
                                <input onChange={this.validatePhone} value={this.state.phone} type='tel' required name={"phone"} />
                            </label>
                            <label>
                                <p>
