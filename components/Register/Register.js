...
export default class Register extends Component {
	...
	mostrarContrasena() {
		...
		if (tipo.type == 'password') {
			tipo.type = 'text';
			this ? this.setState({ visiblePassword: true }) : '';
		} else {
			tipo.type = 'password';
			this ? this.setState({ visiblePassword: false }) : '';
		}
	}
	// handleValidate(){
				...
				<div className="register">
					...
					<form className="form" onSubmit={this.handleSubmit}>
						...
						<div className="password">
							...
							/>
							<button type="button" onClick={this.mostrarContrasena}>
								{this.state.visiblePassword ? <Visibility /> : <VisibilityOff />}
							</button>
						</div>
						<p className="terms">
							...
							<Link href="/privacidad">
								<a>Políticas de privacidad de Kiero.</a>
							</Link>
						</p>
