        ...
        switch (this.props.order.status) {
            ...
            case 5:
                ...
                if (this.props.mode === "sell") {
                    ...
                    status_text = "El vendedor tiene algun problema con el envío, estamos trabajando en ello"
                }
                break;
            case 6:
                status = "Cancelado";
                        ...
                        <a>
                            <section className="product">
                                ...
                                <section className='description'>
                                    ...
                                    <h3>{this.props.order.total ? "$ " + this.props.order.total : "$ 0"}</h3>
                                    <h3 className="product-stock">{product.stock ? "Disponibles " + product.stock : "No hay disponibles"}</h3>
                                </section>
                            </section>
                        </a>
                    </Link>

                    {this.props.mode == "sell" ? <section className="info">
                        <p>Cliente</p>
                        <p>{this.props.order.user.name ? this.props.order.user.name + " " + this.props.order.user.last_name : " - "}</p>
