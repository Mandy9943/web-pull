...
const Shop = ({ store_data, user_data }) => {
	...
	const [store_design, setStoreDesign] = useState({
		...
		st_design_st_design_header_subtitle_font_family:
			st_data.design.header.subtitle.font_family,
	...
	return (
		<div className="summary-content">
			...
			<div
				className={
					closeSidebar ? 'user-account-container' : ' user-account-container show-sidebar'
				}
			>
				...
				{display.facebookLink && (
					...
					>
						<ShopFacebookLink cb={showSection} />
					</ShopEditScreen>
				)}
				{display.theme && (
					<ShopEditScreen
				...
				{display.marketing && (
					...
					>
						<ShopMarketing cb={showSection} />
					</ShopEditScreen>
				)}
				{display.ws && (
					<ShopEditScreen cb={showSection} section={{ text: 'Whatsapp', key: 'ws' }}>
						<ShopWhatsapp cb={showSection} />
					</ShopEditScreen>
				)}
			</div>
