    ...
    return (
        <section className="edit-marketing">
            <header>
                ...
                <p>Con esta herramienta puedes realizar el seguimiento de tus campañas y conocer más sobre las acciones de tus visitantes. Podrás aumentar el tráfico y las ventas de tu tienda.</p>
            </header>
            <main>
                <div className="row">
