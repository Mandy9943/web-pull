      ...
      <Nav dataId={this.props.data.myID} />
        <div className="newContainer">
          <div className="containerChat">
            <div>Ventas  <FontAwesomeIcon icon={faChevronRight} style={{color:"#CF0A2C", padding:"0px 10px 0px 10px"}} />  #123456789</div>
            ...
            <div className="dataUser dataUserResponsive" style={{ marginTop:15}}>
              ...
              <div style={{display:"flex"}}>
                ...
                <div className="userData">
                  <p>Pedro Gonzáles</p>
                  <p>3001234567</p>
                  <span className="detailsShop">Detalles de venta</span>
                </div>
              </div>
            </div>
          ...
          <p className="verifyShop">Una vez confirmes los detalles del producto y el tiempo de entrega podrás calificar la venta como verificada</p>
          <p className="verifyStatus" onClick={() =>this.handleVerify()}>He verificado ésta compra</p>
          </div>
        </div>
        {/* <Footer/> */}
      </>
