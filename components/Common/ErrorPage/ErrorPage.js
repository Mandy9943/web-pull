		...
		<>
			<div id="notfound">
				...
				<div className="notfound">
					...
					<a href="/contactanos_email" className="contact-btn">
						Contáctanos
					</a>
					<div className="notfound-social">
						<a rel="noopener noreferrer" href={fb}>
							<FontAwesomeIcon icon={faFacebookF} />
						</a>
						<a rel="noopener noreferrer" href={ig}>
							<FontAwesomeIcon icon={faInstagram} />
						</a>
						<a rel="noopener noreferrer" href={tw}>
							<FontAwesomeIcon icon={faTwitter} />
						</a>
						<a rel="noopener noreferrer" href={lk}>
							<FontAwesomeIcon icon={faLinkedinIn} />
						</a>
						<a rel="noopener noreferrer" href={pt}>
							<FontAwesomeIcon icon={faPinterestP} />
						</a>
						<a rel="noopener noreferrer" href={yt}>
							<FontAwesomeIcon icon={faYoutube} />
						</a>
						<a rel="noopener noreferrer" href={ws}>
