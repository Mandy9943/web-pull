              ...
              <section className="title-sub">
                ...
                <div className="anullProperties">
                  <Image
                    ...
                    src={urlBanner + this.state.selectedCategory + "/1.webp"}
                  />
                </div>
                <div className="anullProperties">
                  <Image
                    layout="fill"
                    alt={this.state.selectedCategory}
                    src={urlBanner + this.state.selectedCategory + "/2.webp"}
                  />
                </div>
                <div className="anullProperties">
                  <Image
                    layout="fill"
                    alt={this.state.selectedCategory}
                    src={urlBanner + this.state.selectedCategory + "/3.webp"}
                  />
                </div>
                <div className="anullProperties">
                  <Image
                    layout="fill"
                    alt={this.state.selectedCategory}
                    src={urlBanner + this.state.selectedCategory + "/4.webp"}
                  />
                </div>
                <div className="anullProperties">
                  <Image
                    layout="fill"
                    alt={this.state.selectedCategory}
                    src={urlBanner + this.state.selectedCategory + "/5.webp"}
                  />
                </div>
              </section>
