                    ...
                    <div className="filter-group categories">
                        ...
                        <span className="node" onClick={() => this.props.onSelectCategory(node, i)}
                          ...
                          {node.label}
                                                                                ...
                                                                                {node3.items && node3.items.length > 0 && node3.items.map((node4, i4) => {
                                                                                    return (
                                                                                        <div
                                                                                            ...
                                                                                            key={node4.label}>
                                              <span className="node"
                                                    onClick={() => this.props.onSelectCategory(node4, i4)}
                            ...
                            <div style={{marginTop: 12}} className="view-all"
                                 onClick={e => this.viewAll(e.target, 'categories')}>Ver Todos
                            </div>
                        </>}
                    </div>
                ...
                <div className="responsive-filter">
                    ...
                    >
                        <ul>
                            ...
                            <li>Ordenar</li>
                            <li onClick={(e) => this.setSort(e)} value="2" className="responsive-dropdown-item">Menor
                                precio
                            </li>
                            <li onClick={(e) => this.setSort(e)} value="1" className="responsive-dropdown-item">Mayor
                                precio
                            </li>
                            <li onClick={(e) => this.setSort(e)} value="0" className="responsive-dropdown-item">Mas
                                relevante
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <div className="filter-group filter-responsive show">
                                        ...
                                        <form onSubmit={this.handlePrice}>
                                            <div className="wrap-filter-price">
                                                <input placeholder="Minimo" name={"from_price"} type="number"
                                                       size="mini"/>
                                                <p>-</p>
                                                <input placeholder="Maximo" name={"to_price"} type-="number"
                                                       size="mini"/>
