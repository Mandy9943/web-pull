		...
		return (
			<div className="account-data-content">
				...
				{this.state.stateModals.modal1 ? (
					<Modal toggle={this.toggleModal} num="1" content={this.contentModals.modal1} />
				) : null}
				{this.state.stateModals.modal2 ? (
					<Modal toggle={this.toggleModal} num="2" content={this.contentModals.modal2} />
				) : null}
				{this.state.stateModals.modal3 ? (
					<Modal toggle={this.toggleModal} num="3" content={this.contentModals.modal3} />
				) : null}
			</div>
		);
	}
