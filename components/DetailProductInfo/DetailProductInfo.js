        ...
        return (
          <div>
            ...
            <div
              ...
              dangerouslySetInnerHTML={{ __html: this.props.desciption }}
            />
          </div>
        );
      }
    ...
    return (
      <>
        ...
        <Accordion className="showGuide">
          <AccordionSummary
            expandIcon={<ExpandMoreIcon className="detail-expandMore" />}
            aria-controls="panel1a-content"
            id="panel1a-header"
          >
            <h2 className="title-section">Detalle del producto</h2>
          </AccordionSummary>
          <AccordionDetails>
            ...
            <div>
              <div className="wrap-detail-info-movil">
                <div className="item-detail-info">
                  <h2 className="title-section accent">
                    {" "}
                    {this.props.product_name.substring(0, 80)}
                  </h2>
                  <br />
                  <br />
...
asumir el valor del retorno a una de las direcciones que se le indicará, el valor del envío varía según el peso y el tamaño del producto. */}
            ...
            {/* <div dangerouslySetInnerHTML={ {__html: this.state.dataguide} } /> */}
          </AccordionDetails>
        </Accordion>
          ...
          <section className="characteristics-web no-movil">
            ...
            <div className="detail-infoSeller-wrapp">
              ...
              <p className="info-section">
                Spice Stock SAS, actúa solo como intermediaro o gestor entre un
                cliente nacional que hace una compra y un proveedor en el
                extranjero que comercializa el producto
              </p>
              <br></br>
              <p className="info-section">
                Este producto viene desde Estados Unidos
              </p>
              <p className="info-section">Entrega de 3 a 9 días hábiles</p>
