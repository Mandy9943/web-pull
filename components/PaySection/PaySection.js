    ...
    render() {
        ...
        const contentModalNewAddress = (
            <div style={{display: 'flex', justifyContent: 'center', flexDirection: 'column'}}>
                <p style={{textAlign: 'center', fontWeight: 'bold', paddingBottom: 30}}>Por favor agregue los datos de
                    envío</p>
                <div style={{width: '300px', margin: '0 auto'}}>
                    ...
                    {/*	name="neighborhood"*/}
                    {/*/>*/}
                    <form className="finish-pay" method="post"
                        ...
                        <input name="responseUrl" type="hidden" value="https://api.kieroapi.org/pay_result"/>
                        <input name="confirmationUrl" type="hidden" value="https://api.kieroapi.org/payuComplete"/>
                        <input className="button-finish-pay" onMouseDown={this.validateForm}
                               disabled={this.state.disabledButton}
                               style={{
                                   background: this.state.disabledButton ? '#cf0a2c' : '#cf0a2c',
                                   color: 'white',
                                   cursor: 'pointer'
                               }} name="Submit" type="submit" value="Continuar con la transacción"/>
                    </form>
                ...
                {!this.state.validForm ? (
                    <div style={{
                        ...
                        <p style={{textAlign: 'center', fontWeight: 'bold', marginTop: 10.5}}>Tienes campos pendientes
                            por completar</p>
                    </div>
                ) : (
                    ''
