...
if (process.env.NODE_ENV !== "production") {
	...
	var baseUrl = "https://kieroapi.net/"; // var baseUrl = 'https://kieroapi.org/'
	var urlApi = "https://api.kieroapi.net"; // var urlApi = 'https://api.kieroapi.org'
	var urlImages = "http://kieroapi.net/images/"; // var urlImages = 'http://kieroapi.org/images/';
	//ROUTES for search
	var searchBaseUrl = "https://api.kieroapi.net/search"; // var searchBaseUrl = 'https://api.kieroapi.org/search';
	var wompi_at_url =
