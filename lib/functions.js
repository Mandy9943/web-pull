...
export const createlead = async (payload, step) => {
  ...
  if(step === 1){
    ...
    step_value = "Usuario Invitado (Y Usuario Registrado) que Presionó el botón de Continuar con la transacción";
  }
  else if (step === 3) {
  ...
  const data = {
    ...
    product_title: payload.product_global_title.slice(0, 250),
