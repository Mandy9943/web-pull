...
function Results({data, session}) {
    ...
    var complete = {
        ...
        "bebés": {"estructure":[1, 2, 3, 2, 3, 2, 1],
        ...
        "cámaras y accesorios":  {"estructure":[1, 2, 3, 2],
        ...
        "celulares y teléfonos":{"estructure":[1, 2, 3, 2],
        ...
        "electrónica": {"estructure":[1, 2, 3, 2, 3, 2, 3, 2, 1],
        ...
        "hogar y muebles": {"estructure":[1, 2, 3, 2, 1],
