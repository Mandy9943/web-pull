		...
		return (
			<div className="home">
				<Head>
					...
					<meta
						name="twitter: card"
						content="Encuentra todo lo relacionado con productos de category_name en kiero.co"
					/>
					...
					<meta
						...
						contenido=" Envíos gratis en Colombia - Encuentra productos de c
					...
					<meta
						property="og:title"
						content="Compra category_name en Kiero.co Compra Portatiles y accesorios en
                    Kiero.co "
					/>
					<meta
						property="og:description"
						content="Encuentra category_name en Kiero.co - Descubre millones de p
