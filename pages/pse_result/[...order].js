			...
			<section className="order-content">
				<section className="info">
					...
					<span className="user-id">
						USERID: <strong>{data.user_id}</strong>
					</span>
					<span>
						SELLERID: <strong>{data.seller_id}</strong>
					</span>
					<span>
						Método de pago: <strong>{data.method_id}</strong>
					</span>
					<span>
						Estado del pago:
						<strong>
					...
					<span>
						Total a pagar: <strong>{data.total} </strong>
					</span>
					<span className="name-product">
						Nombre del producto: <strong>{data.product.title}</strong>
					</span>
				</section>
			</section>
			<Footer />
